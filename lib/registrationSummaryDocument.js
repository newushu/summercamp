...
function buildStyledSummaryPdfBase64({
  ...
  function drawMarketingBox(topY) {
    ...
    const nextY = drawText('Encouraging Next Step', margin + 14, topY - 22, {
      font: 'F2',
      fontSize: 14,
      leading: 16,
...
export function buildRegistrationSummaryDocument({
  ...
  const siblingEligibleIds = getSiblingDiscountEligibleIdsForStudents(students, tuition, { applyLimitedDiscount })
  const pdfLines = [
    ...businessLines,
