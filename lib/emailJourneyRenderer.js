  ...
  const stageMap = {
    sevenDay: {
      ...
      lines: [
        ...
        '',
        'What to bring every day: athletic training clothes, water bottle (labeled), and a positive mindset. Tuesday outdoor time may call for sunscreen and a change of outdoor shoes. Water Wednesdays require an extra change of clothes. Thursday BBQ lunch is provided. Friday 4:30 PM showcase is open to all families.',
        '',
    ...
    fiveDay: {
      ...
      lines: [
        ...
        '- Friday: plan to attend the 4:30 PM family performance showcase.',
        '',
    ...
    threeDay: {
      ...
      lines: [
        ...
        '- Friday showcase at 4:30 PM — families are welcome and encouraged.',
        '',
    ...
    oneDay: {
      ...
      lines: [
        ...
        '',
        'Friday at 4:30 PM is the family showcase — mark your calendar. It is one of the highlights of each week.',
        '',
