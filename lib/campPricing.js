...
const PROMO_QUOTA_STABLE_REMAINING = 6
...
export function getWeekTierPromoQuotaStatus() {
  return {
    initialQuota: PROMO_QUOTA_INITIAL,
    consumed: PROMO_QUOTA_INITIAL - PROMO_QUOTA_STABLE_REMAINING,
    remaining: PROMO_QUOTA_STABLE_REMAINING,
    weeksElapsed: 0,
  }
}
