...
async function fetchAdminConfigFromSupabase() {
    ...
    const [settingsResponse, windowsResponse, weeksResponse] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('camp_admin_settings').select('hero_image_url, level_up_image_url, level_up_screenshot_urls, level_up_screenshot_size').eq('id', true).maybeSingle(),
...
_s(AdminPage, "kugM7RBm3jOBPacuFEKJkW73qUc=", false, function() {
    return [
...
//# sourceMappingURL=_d68850fa._.js.map