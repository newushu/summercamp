...
async function fetchAdminConfigFromSupabase() {
    ...
    const [settingsResponse, windowsResponse, weeksResponse] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('camp_admin_settings').select('hero_image_url, level_up_image_url').eq('id', true).maybeSingle(),
...
function AdminPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        let active = true;
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$campAdminApi$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchAdminConfigFromSupabase"])().then(({ data, error })=>{
            if (!active) {
                return;
            }
            if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__852a33f3._.js.map