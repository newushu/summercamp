...
"[project]/app/api/email/send-test/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!subject || !content) {
            return Response.json({
                error: 'Template subject/body is required.'
            }, {
                status: 400
            });
        }
        ...
        if (!apiKey || !fromEmail) {
            return Response.json({
                ...
                configured: false,
                previewOnly: true,
                message: 'Missing SENDGRID_API_KEY or SENDGRID_FROM_EMAIL. Add them in .env to send real test emails.'
            }, {
                status: 200
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ffa2122f._.js.map